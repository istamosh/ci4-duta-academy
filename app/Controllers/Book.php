<?php
    ...
    class Book extends BaseController {
        ...
        public function formEdit() {
            ...
            // sending the validator and display the chosen book as currentDetails var.
            $componentsAndDossier = [
                'validation' => \Config\Services::validation(),
                'currentDetails' => $this->databaseModel->fetchBookData($id)
            ];
        ...
        public function update() {
            ...
            // deletes a file on local storage upon updating to new image
            if (file_exists('blob_images/' . $this->request->getVar('old_cover'))) {
                unlink('blob_images/' . $this->request->getVar('old_cover'));
            }
            ...
            return redirect()->
                to('/book')->
                with('update', 'Book has been successfully updated!');
        }
        ...
        public function delete() {
            ...
            // and delete the attached file too
            if (file_exists('blob_images/' . $this->request->getVar('cover_for_deletion'))) {
                unlink('blob_images/' . $this->request->getVar('cover_for_deletion'));
            }
