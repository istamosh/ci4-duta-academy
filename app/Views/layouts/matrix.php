<!-- layout copied from \public\templates\matrix-admin-bootstrap5\html\index.html -->
<!-- remember: in this case, relpath is accessed from public directory (localhost = /public/index.php) -->
